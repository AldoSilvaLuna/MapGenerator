...
public class MeshGenerator : MonoBehaviour {
	...
	Dictionary<int, List<Triangle>> triangleDictionary = new Dictionary<int, List<Triangle>>();//Takes on a key and a value
	...
	void CreateWallMesh(){
		...
		foreach(List<int> outline in outlines){
			for(int i = 0; i < outline.Count - 1; i++){
				...
				wallVertices.Add (vertices[outline[i]] - Vector3.up * wallHeight);		//Bottom teft vertex
				wallVertices.Add (vertices[outline[i + 1]] - Vector3.up * wallHeight);	//Bottom right vertex

				//First Triangle
				wallTriangles.Add (startIndex);		//Top left vertex
				wallTriangles.Add (startIndex + 2);	//Bottom Left Vertex
				wallTriangles.Add (startIndex + 3);	//Bottom Right Vertex

				//Second Triangle
				wallTriangles.Add (startIndex + 3);	//Bottom Right Vertex
				wallTriangles.Add (startIndex + 1);	//Top Right Vertex
				wallTriangles.Add (startIndex);		//Top Left Vertex
			}
		}
	...
	struct Triangle{
		...
		public int this[int i]{	//This method lets you acces vertices from the struct like an array 
			get { 
				return vertices [i];
			}
		}
